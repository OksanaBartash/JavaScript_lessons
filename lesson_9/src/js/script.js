...
//const elementsNumber = parseInt(prompt(`Ведіть кількість елементів масиву`, 6))
//let zerosArr = new Array(elementsNumber).fill(0)
//document.write(`${zerosArr}`)
//============================
...
//const elementsNumber = parseInt(prompt(`Ведіть кількість елементів масиву`, 6))
//const halfLenght = Math.floor(elementsNumber / 2)
//const numbersArr = new Array(elementsNumber).fill(1, 0, halfLenght).fill(7, halfLenght)
//document.write(numbersArr.join(", "));
